...
class ShowStats(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        # ID du serveur autorisé
        self.allowed_guild_id = 1380282831347122267
        
        # Configuration par défaut
        default_guild = {
            "enabled": True,
            "members_channel_id": 1380647428465627146,  # Canal pour afficher le nombre de membres
            "boosts_channel_id": 1380647292796665966,   # Canal pour afficher le nombre de boosts
    ...
    async def update_stats_loop(self):
        ...
        while not self.bot.is_closed():
            try:
                # Mettre à jour les statistiques seulement pour le serveur autorisé
                ...
                if guild:
                    ...
                    update_interval = 300  # Valeur par défaut
    ...
    async def showstats_commands(self, ctx):
        ...
        if ctx.guild.id != self.allowed_guild_id:
            error_embed = discord.Embed(
                ...
                description="Ce système de statistiques n'est disponible que sur le serveur Radiant Order.",
        ...
        if ctx.invoked_subcommand is None:
            ...
            embed.set_footer(text="Radiant Order - Système de statistiques")
